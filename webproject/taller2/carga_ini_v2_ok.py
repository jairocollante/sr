...
def content_user_recomendation(userid,k):
  ...
  if len(pred) <1:
    print("El modelo del usuario en la predicción de la clase es False, tiene pocos Ratings y la mayoria en False")
    return None
...
def best_n_hybrid_recomendations(userid,n,k):
  ...
  bisness =bisness[['business_id','name','state', 'city', 'address','stars','categories']][:10]
